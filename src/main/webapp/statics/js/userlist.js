...
$(function(){
	...
	$(".viewUser").on("click",function(){
		...
		var obj = $(this);
		/*window.location.href="/user/view.html/"+ obj.attr("userid");*/
		$.getJSON("/user/user_view?id="+obj.attr("userid"), function(result){
			if( result==null){
				alert("操作超时！");
			}else{
	...
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href="/user/modify.html?uid="+ obj.attr("userid");
	});
